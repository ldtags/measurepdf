"""
Authors  - Akash Bora, Liam Tangney
Original - https://github.com/Akascape/CTkToolTip
"""
...
from tkinter import Toplevel, Frame, Event


class ToolTip(Toplevel):
    """Creates a ToolTip (pop-up) widget for ctk."""
